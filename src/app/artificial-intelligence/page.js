//=============== Import Components
import { Hero4, Trun, Feedback, Solution, Work, Trust, Startup, Journey, Technologies, Choose, Showcasing, Quote, Recognition, Contact, Faqs, AwardLogos, } from "@/components";
//========== Import Hero Images
import BanImg1 from "media/artificial/banImg.png"
...
import solution1 from "media/artificial/solution1.png"
import solution2 from "media/artificial/solution2.png"
import solution3 from "media/artificial/solution3.png"
//=============== Import work Images
...
export default function Home() {
  //=============== Hero ===============
  const heroContent = {
    title: "Bitswits Is A Home To All Your Demands Regarding",
    subtitle: (<> Artificial <span className="text-primary-100">Intelligence </span> <br /> Development And <br /> Advancement </>),
    BanImg1: BanImg1,
  };
  //=============== Feedback ===============
  const testimonials = [
  ...
  const solutions = [
    {
      image: solution1,
      title: 'Smart Systems',
      description: 'We create clever systems that can do tasks automatically for your business, can understand information, learn from it'
    },
    {
      image: solution2,
      title: 'Gesture Recognition',
      description: 'BitsWits specializes in creating technology that can recognize and respond to your movements. Our systems understand gestures'
    },
    {
      image: solution3,
  ...
  const solutionContent = {
    ...
    title: (<> Our Advanced Artificial Intelligence <br /> Development Services </>),
    solutions: solutions,
  };
  //=============== Work ===============
  const workData = [
